...
export class DepoimentsService {
    ...
    depoiments: Depoiment[] = [
        ...
        },
        {
            ...
            age: 17,
            text: "Palavras não são suficientes para expressar minha gratidão a essa plataforma incrível. Nunca imaginei que a internet poderia ser uma fonte de realização profissional. Sou grato por me apontarem o caminho certo e os passos necessários para alcançar meus objetivos. Mesmo eu que não sabia nada sobre internet consegui alcançar ganhos expressivos em pouco tempo, pois vocês ensinam do absoluto zero ao avançado, o que fez total diferença na minha jornada de sucesso!",
